      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-slate-300">Git Source Repository URL</label>
            <input
              type="text"
              value={gitUrl}
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-slate-300">Cartridge Manifest Specification (cartridge.yaml)</label>
            <textarea
              rows={12}
              value={cartridgeYaml}
        ...
        <div className="space-y-6">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div className="flex items-start space-x-2.5 p-3 rounded-lg bg-slate-950 border border-slate-800">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                <div>
                  <div className="font-semibold text-white">Zero Plaintext Secret Exposure</div>
              ...
              <div className="flex items-start space-x-2.5 p-3 rounded-lg bg-slate-950 border border-slate-800">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                <div>
                  <div className="font-semibold text-white">Dynamic Egress Policy Synthesis</div>
                  <p className="text-slate-400 mt-0.5 leading-relaxed">
                    Outbound routes and external hosts declared in <code className="text-emerald-400">cartridge.yaml</code> are automatically synced to gateway policy rules.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2.5 p-3 rounded-lg bg-slate-950 border border-slate-800">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                <div>
                  <div className="font-semibold text-white">Dedicated IAM Task Role Provisioning</div>
                  <p className="text-slate-400 mt-0.5 leading-relaxed">
                    Each deployed agent receives an isolated ECS Task Role scoped strictly to its private mind prefix <code className="text-emerald-400">s3://.../&lt;agent&gt;/</code>.
                  </p>
                </div>
              </div>
            </div>
          ...
          {validationResult && (
            <div className="bg-emerald-950/80 border border-emerald-800 p-4 rounded-xl text-xs space-y-1 animate-fade-in">
              ...
              <p className="text-emerald-400/80">{validationResult.message}</p>
            </div>
          )}
        </div>
      </div>
